    ...
    newProductDiv.innerHTML = `
        <div  class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-md-3" hidden>
                <div class="form-group" >
                    <label>BD</label>
                    <input class="form-control cantidad" name="can" type="number"  value="100" required>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
            ...
            <div class="col-md-3">
                ...
                <button type="button" class="btn btn-warning but2" data-id="${uniqueId}">
                    <i class="glyphicon glyphicon-list-alt"></i>
                </button>
                <button type="button" class="btn btn-info but3" data-id="${uniqueId}">
                    <i class="glyphicon glyphicon-list-alt"></i>
                </button>
            </div>
            <br>
...
// Este codigo es para ver lo que son los servicios que tengo en mi base de datos
$(document).ready(function () {
    // Delegación del evento click para el botón de la clase but3
    $(document).on('click', '.but3', function () {
        var uniqueId = $(this).data('id');
        $('.moseservicio').data('unique-id', uniqueId).dialog({
    ...
    $(document).on('click', '#myTable3 tbody button', function () {
        var uniqueId = $('.moseservicio').data('unique-id');
        var row = $(this).closest('tr');
        var p_nombre = $.trim(row.find('.ser1').text());
        var precio = $.trim(row.find('.ser2').text());
...
// Este codigo es para ver lo que son los productos que tengo en mi base de datos
$(document).ready(function () {
